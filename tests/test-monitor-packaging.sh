...
assert_eq "ReadWritePaths=$FIX_STATE -/run/sbox-cm" "$(grep '^ReadWritePaths=' "$FIX_UNIT")" "writable exceptions = monitor data root + M2 socket connect carve-out (M2-E: consciously updated contract)"
